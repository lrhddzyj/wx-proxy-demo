...
//import org.springframework.util.Asserts;
...
public abstract class ReflectionUtils {
	...
	public static <T> T getFieldValue(final Object target,
		...
		Asserts.notNull(fieldName, "fieldName");
	...
	public static Field getAccessibleField(final Class targetClass,
			final String fieldName) {
		Asserts.notNull(targetClass, "targetClass");
		Asserts.notNull(fieldName, "fieldName");
	...
	public static <T extends Annotation> T getAnnotation(Class targetClass,
		...
		Asserts.notNull(targetClass, "targetClass");
		Asserts.notNull(annotationClass, "annotationClass");
	...
	public static <T extends Annotation> T getAnnotation(
		...
		Asserts.notNull(constructor, "constructor");
		Asserts.notNull(annotationClass, "annotationClass");
