 ...
 */
public class BatchSendVoiceMessageCmd extends WxJsonCommand {

    private Long msgId;

    public BatchSendVoiceMessageCmd(String mediaId) {
        super("batchSendVoice");
        addVariable("isToAll",Boolean.TRUE.toString());
        addVariable("groupId","0");
        addVariable("mediaId",mediaId);
    }
    public BatchSendVoiceMessageCmd(Integer groupId, String mediaId) {
        super("batchSendVoice");
        addVariable("isToAll",Boolean.FALSE.toString());
        addVariable("groupId",groupId.toString());
        addVariable("mediaId",mediaId);
    }
    public BatchSendVoiceMessageCmd(List<String> users, String mediaId) {
        super("sendVoiceToUsers");
