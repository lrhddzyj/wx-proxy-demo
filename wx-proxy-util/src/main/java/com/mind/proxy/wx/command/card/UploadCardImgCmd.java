 ...
 */
public class UploadCardImgCmd extends WxJsonCommand {
    ...
    public UploadCardImgCmd(String fileName, byte[] buffer) {
        super("uploadCardImg");
    ...
    protected void doExecute() throws Exception {
        try {
            ...
            throw new WeiXinException(90002,"上传卡券图片到微信服务器出错:"+e.getMessage());
        }
    }
